...
public class SuperStar extends Fragment {
    ...
    public static SuperStar newInstance(){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        category = database.getReference().child("Groups").child("SuperStar").child("Category");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_super_star,container,false);

        listCategory = (RecyclerView) myFragment.findViewById(R.id.superStar_list);
            ...
            protected void populateViewHolder(final CategoryViewHolder viewHolder, final Category_model model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Common.classID = "superstar";
                        startIntent.putExtra("category_name","SuperStar");
