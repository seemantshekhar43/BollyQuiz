...
public class Struggler extends Fragment {
    ...
    public static Struggler newInstance(){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        category = database.getReference().child("Groups").child("Struggler").child("Category");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_struggler,container,false);

        listCategory = (RecyclerView) myFragment.findViewById(R.id.struggler_list);
